...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.marbles_daniel_simon);
        ...
        scrubControl = findViewById(R.id.scrubSeekBar);
